...
public class OldDataset {
    ...
    public OldDataset(String[][] data,int setNum, int nameListPos, int dataColumnCount) throws ParseException{
        this.data = data;
        this.setNum = setNum;
    ...
    public OldDataset(String[][] data) throws ParseException{
        this.data = data;
    ...
    public OldDataset compareTo(OldDataset s) throws ParseException{
        ...
        OldDataset d = new OldDataset(newData);
