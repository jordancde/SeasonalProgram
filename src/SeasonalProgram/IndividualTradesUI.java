...
public class IndividualTradesUI extends JPanel {
        ...
        public String loadPresets() throws URISyntaxException, IOException{
            ...
            */
            String path = location.getFile().substring(0,location.getFile().lastIndexOf(SeasonalProgram.directoryChar))+SeasonalProgram.directoryChar+"INDPRESET"+presetName+".csv";
            return path;
